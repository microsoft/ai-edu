...
|4|Indifferent Quality|无差异功能|无所谓，放那儿吧|
...
又称兴奋型功能，指不会被用户过分期望的，或者是用户没有想到的功能。
...
对待任何事物的好坏的判断，用户的态度一般不是非此即彼的0/1问题，而是有一个过渡，这是一个心理学问题。

在微软面试中，也要求面试官给“Hire”或“No hire”，但有时候太难选择了，所以会出现一个“Weak hire”的选择。
...
|Word保存为PDF格式|太激动了|比较不错|勉强接受|不太满意|太差劲了|
|--|--|:--:|:--:|:--:|:--:|
|提供此功能时||$\sqrt{}$||||
|没有此功能时|||||$\sqrt{}$|
...
这个很简单，因为一百个人眼中有一百个林黛玉。我们要做的，是满足目标用户人群中多数人的功能。
...
昨天的期望型功能，甚至魅力型功能，到今天可能已变成了必备型功能。
...
- [1] KNAO用户满意度模型 https://en.wikipedia.org/wiki/Kano_model
- 
