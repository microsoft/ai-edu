  ...
  for step in xrange(int(num_epochs * train_size) // BATCH_SIZE):
    ...
    if step % EVAL_FREQUENCY == 0:
      ...
      if(loss <= best_loss):
        ...
        np.save("conv1_b.npy", mnistModel.conv1.bias)
        np.save("conv2_w.npy", mnistModel.conv2.weights)
        np.save("conv2_b.npy", mnistModel.conv2.bias)
        np.save("fc1_w.npy", mnistModel.fc1.weights)
        np.save("fc1_b.npy", mnistModel.fc1.bias)
        np.save("fc2_w.npy", mnistModel.fc2.weights)
        np.save("fc2_b.npy", mnistModel.fc2.bias)
