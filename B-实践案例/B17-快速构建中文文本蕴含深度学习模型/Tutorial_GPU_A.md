# 快速构建中文文本蕴含深度学习模型-NeuronBlocks-GPU_A
...
- [快速构建中文文本蕴含深度学习模型-NeuronBlocks-GPU_A](#快速构建中文文本蕴含深度学习模型-neuronblocks-gpu_a)
- [目录](#目录)
- [案例介绍](#案例介绍)
  - [案例价值](#案例价值)
  - [使用场景](#使用场景)
...
## 环境与工具
本案列运行具有算力大于3.5的Nvidia显卡的计算机上，系统可以是Windows / Macos / Linux
需要的软件环境如下：
- Python 3.7  
- CUDA 11.1
- cuDNN 8.1.0
...
如果您显卡的算力小于等于3.5，请选择[GPU_B流程](./Tutorial_GPU_B.md)
