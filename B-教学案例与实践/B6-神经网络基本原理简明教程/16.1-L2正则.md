...
黄色的圆形，就是正则项所处的区域。当w值一定时，这个区域的大小，是由参数$\lambda$所控制的，该值越大，黄色圆形区域越大。比如图中分别标出了该值为0.7、0.8、0.9的情况。
...
```
epoch=199, total_iteration=7999
loss_train=0.0359, accuracy_train=1.000000
loss_valid=0.8170, accuracy_valid=0.870000
time used: 7.951735973358154
total weights abs sum= 3557.3309052129034
total zero weights = 54
```
