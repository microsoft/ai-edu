...
|01|[神经网络的基本工作原理](01-神经网络的基本工作原理.md)
|02.0|[反向传播与梯度下降](02.0-反向传播与梯度下降.md)
|02.1|[线性反向传播](02.1-线性反向传播.md)
|02.2|[非线性反向传播](02.2-非线性反向传播.md)
|02.3|[梯度下降](02.3-梯度下降.md)
|03.0|[损失函数](03.0-损失函数.md)
|03.1|[均方差损失函数](03.1-均方差损失函数.md)
|03.2|[交叉熵损失函数](03.2-交叉熵损失函数.md)
|04.0|[单入单出单层](04.0-单入单出单层-单变量线性回归.md)
|04.1|[最小二乘法](04.1-最小二乘法.md)
|04.2|[梯度下降法](04.2-梯度下降法.md)
|04.3|[神经网络法](04.3-神经网络法.md)
|04.4|[梯度下降的三种形式](04.4-梯度下降的三种形式.md)
|05.0|[多入单出单层](05.0-多入单出单层-多变量线性回归.md)
|05.1|[正规方程法](05.1-正规方程法.md)
|05.2|[神经网络法](05.2-神经网络法.md)
|05.3|[样本特征数据的归一化](05.3-样本特征数据的归一化.md)
|05.4|[归一化的后遗症](05.4-归一化的后遗症.md)
|05.5|[正确的推理方法](05.5-正确的推理方法.md)
|05.6|[归一化标签值](05.6-归一化标签值.md)
|06.0|[激活函数](06.0-激活函数.md)
|06.1|[挤压型激活函数](06.1-挤压型激活函数.md)
|06.2|[半线性激活函数](06.2-半线性激活函数.md)
|07.0|[多入多出单层神经网络](07.0-多入多出单层神经网络-多变量线性分类.md)
|07.1|[二分类原理](07.1-二分类原理.md)
|07.2|[线性二分类实现](07.2-线性二分类实现.md)
|07.3|[线性二分类结果可视化](07.3-线性二分类结果可视化.md)
|07.4|[多分类原理](07.4-多分类原理.md)
|07.5|[线性多分类实现](07.5-线性多分类实现.md)
|07.6|[线性多分类结果可视化](07.6-线性多分类结果可视化.md)
|08.0|[单入单出双层](08.0-单入单出双层-单变量非线性拟合.md)
|08.1|[双层神经网络的结构](08.1-双层神经网络的结构.md)
|08.2|[双层神经网络的实现](08.2-双层神经网络的实现.md)
|08.3|[权重矩阵初始化](08.3-权重矩阵初始化.md)
|08.4|[参数调整](08.4-参数调整.md)
|08.5|[搜索最优学习率](08.5-搜索最优学习率.md)
|09.0|[多入多出双层](09.0-多入多出双层-双变量非线性多分类.md)
|09.1|[非线性多分类实现](09.1-非线性多分类实现.md)
|09.2|[非线性多分类结果可视化](09.2-非线性多分类结果可视化.md)
|09.3|[梯度下降优化算法](09.3-梯度下降优化算法.md)
|09.4|[自适应学习率算法](09.4-自适应学习率算法.md)
|10|[多入多出多层](10-多入多出多层-多变量非线性多分类.md)
|10|[扩展阅读](10-扩展阅读.md)
|11.1|[神经网络模型概述](11.1-神经网络模型概述.md)
|11.2|[Windows模型的部署](11.2-Windows模型的部署.md)
|11.3|[Android模型的部署](11.3-Android模型的部署.md)