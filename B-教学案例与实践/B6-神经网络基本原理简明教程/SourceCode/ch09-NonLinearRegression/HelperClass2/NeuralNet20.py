...
from HelperClass2.HyperParameters20 import *
...
from HelperClass2.WeightsBias20 import *

class NeuralNet20(object):
    def __init__(self, hp, model_name):
        ...
        self.wb1 = WeightsBias20(self.hp.num_input, self.hp.num_hidden, self.hp.init_method, self.hp.eta)
        self.wb1.InitializeWeights(self.subfolder, False)
        self.wb2 = WeightsBias20(self.hp.num_hidden, self.hp.num_output, self.hp.init_method, self.hp.eta)
