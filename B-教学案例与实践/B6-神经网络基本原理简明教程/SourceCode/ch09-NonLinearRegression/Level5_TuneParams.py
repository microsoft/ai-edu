...
def train(hp):
    net = NeuralNet2(hp, "complex_turn")
    net.train(dataReader, 50, True)
    trace = net.GetTrainingTrace()
    return trace


def ShowLossHistory(file1, hp1, file2, hp2, file3, hp3, file4, hp4):
...
def try_hyperParameters(n_hidden, batch_size, eta):
...
if __name__ == '__main__':
    ...
    file_1, hp1 = try_hyperParameters(ne, batch, eta)

    ne, batch, eta = 4, 10, 0.3
    file_2, hp2 = try_hyperParameters(ne, batch, eta)
    
    ne, batch, eta = 4, 10, 0.5
    file_3, hp3 = try_hyperParameters(ne, batch, eta)

    ne, batch, eta = 4, 10, 0.7
    file_4, hp4 = try_hyperParameters(ne, batch, eta)
    
    ShowLossHistory(file_1, hp1, file_2, hp2, file_3, hp3, file_4, hp4)
