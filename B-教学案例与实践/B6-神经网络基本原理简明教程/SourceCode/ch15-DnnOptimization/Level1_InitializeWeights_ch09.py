...
def model(learning_rate, init_method):
    ...
    net = NeuralNet_4_1(hp, "initialize_trial")
...
if __name__ == '__main__':
    #model(0.1, InitialMethod.Zero)
    model(0.1, InitialMethod.Normal)
    model(0.1, InitialMethod.Xavier)
    model(0.1, InitialMethod.MSRA)
