...
$$
\frac{\partial J}{\partial w_1}=\frac{\partial J}{\partial z_i}\frac{\partial z_i}{\partial w_1}=(z_i-y_i) \cdot x_{i1} \tag{3}
$$
$$
\frac{\partial J}{\partial w_2}=\frac{\partial J}{\partial z_i}\frac{\partial z_i}{\partial w_2}=(z_i-y_i) \cdot x_{i2} \tag{4}
$$
...
$$
$$
J = \frac{1}{2 \times 3}[(z_1-y_1)^2+(z_2-y_2)^2+(z_3-y_3)^2]
$$
$$
\frac{\partial J}{\partial W}=
\begin{pmatrix}
