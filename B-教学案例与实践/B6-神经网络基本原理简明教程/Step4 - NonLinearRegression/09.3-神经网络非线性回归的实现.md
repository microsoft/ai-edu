...
$$
=\begin{pmatrix}
    x \cdot w1_{11}+b1_{1} & x \cdot w1_{12}+b1_{2} & x \cdot w1_{13}+b1_{3}
\end{pmatrix} \tag{1}
$$
$$
a1 = Sigmoid(z1)
...
$$
$$
=a1_{1}w2_{11}+a1_{2}w2_{21}+a1_{3}w2_{31}+b2_{1} \tag{3}
$$
...
\begin{pmatrix}
    {\partial loss \over \partial z}{\partial z \over \partial w2_{11}} \\
    \\
    {\partial loss \over \partial z}{\partial z \over \partial w2_{21}} \\
    \\
    {\partial loss \over \partial z}{\partial z \over \partial w2_{31}}
\end{pmatrix}
=
\begin{pmatrix}
    (z-y) \cdot a1_{1} \\
