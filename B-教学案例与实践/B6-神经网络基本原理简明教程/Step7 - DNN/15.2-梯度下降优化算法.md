...
|隐层神经元数|损失函数与准确率|
|---|---|
|3|<img src="..\Images\15\op_sgd_ch09_loss_n3.png">|
||在隐层只有3个神经元时，迭代10000个epoch不能很好地完成拟合|
|4|<img src="..\Images\15\op_sgd_ch09_loss_n4.png">|
...
|算法|损失函数和准确率|
|---|---|
|SGD|<img src="..\Images\15\op_sgd_ch09_loss_n4.png">|
||上图普通梯度下降算法经过epoch=8000次到达0.002的损失值|
|Momentum|<img src="..\Images\15\op_momentum_ch09_loss_n4.png">|
...
|Momentum|<img src="..\Images\15\op_momentum_ch09_loss_n4.png">|
||上图动量算法经过1600个epoch迭代结束|
|NAG|<img src="..\Images\15\op_nag_ch09_loss_n4.png">|
