...
|学习率|损失函数值变化|
|---|---|
|0.3|<img src="..\Images\15\op_adagrad_ch09_loss_03.png">|
|0.5|<img src="..\Images\15\op_adagrad_ch09_loss_05.png">|
|0.7|<img src="..\Images\15\op_adagrad_ch09_loss_07.png">|
...
|初始学习率|损失函数值|
|---|---|
|0.1|<img src="..\Images\15\op_adadelta_ch09_loss_01.png">|
|0.01|<img src="..\Images\15\op_adadelta_ch09_loss_001.png">|
...
|初始学习率|损失函数值|
|---|---|
|0.1|<img src="..\Images\15\op_rmsprop_ch09_loss_01.png">|<
||迭代了10000次，损失值一直在0.005下不来，说明初始学习率太高了，需要给一个小一些的初值|
|0.01|<img src="..\Images\15\op_rmsprop_ch09_loss_001.png">|
||合适的学习率初值设置||
|0.005|<img src="..\Images\15\op_rmsprop_ch09_loss_0005.png">|
...
|初始学习率|损失函数值|
|---|---|
|0.1|<img src="..\Images\15\op_adam_ch09_loss_01.png">|
||迭代了10000次，但是损失值没有降下来，因为初始学习率0.1太高了|
|0.01|<img src="..\Images\15\op_adam_ch09_loss_001.png">|
||比较合适的学习率|
|0.005|<img src="..\Images\15\op_adam_ch09_loss_0005.png">|
||学习率较低|
|0.001|<img src="..\Images\15\op_adam_ch09_loss_0001.png">|
