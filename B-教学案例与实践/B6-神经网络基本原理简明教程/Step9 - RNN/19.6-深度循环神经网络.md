...
在循环神经网络中，会有同样的需求，要求每一时刻的网络是由多个隐层组成。比如下图为两个隐层的循环神经网络，用于解决和19.4节中的同样的问题：
...
|预测时长|损失函数值与准确度|拟合结果|
|---|---|---|
|8|0.001225<br/>0.725709|<img src="../Images/19/deeprnn_PM25_fitting_result_48_8.png"/>
|4|0.000668<br/>0.850514|<img src="../Images/19/deeprnn_PM25_fitting_result_48_4.png"/>
|2|0.000386<br/>0.913654|<img src="../Images/19/deeprnn_PM25_fitting_result_48_2.png"/>
|1|0.000240<br/>0.946374|<img src="../Images/19/deeprnn_PM25_fitting_result_48_1.png"/>
...
||单层循环神经网络|双层循环神经网络|
|---|---|---|
|损失函数值|0.001432|0.001225|
|准确度值|0.679348|0.725709|
|参数个数|44|39|
