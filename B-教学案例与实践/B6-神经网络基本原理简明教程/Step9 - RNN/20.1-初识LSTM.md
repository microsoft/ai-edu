...
= \delta_t \circ \tanh(c_t) \circ o_t \circ (1 - o_t) \tag{17}
$$
...
= \delta_{z_{ft}} \cdot W_f + \delta_{z_{it}} \cdot W_i + \delta_{z_{\tilde{c}t}} \cdot W_c + \delta_{z_{ot}} \cdot W_o
$$
...
= \delta_{z_{ft}} \cdot U_f + \delta_{z_{it}} \cdot U_i + \delta_{z_{\tilde{c}t}} \cdot U_c + \delta_{z_{ot}} \cdot U_o
$$
