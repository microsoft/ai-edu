...
- 先修知识：了解C#基本语法。[点击这里查看参考资料](./A-教学课程/先修知识参考阅读#C#)
- 学习时长：10~16 小时
...
- 内容：基础人工智能案例资源，覆盖计算机视觉，自然语言处理，语音识别等领域。
- 先修知识：Python;CNN;RNN;主流深度学习框架[点击这里查看参考资料](./A-教学课程/先修知识参考阅读#Python)
- 学习时长：20~30小时
...
<font size=2>[访问Version 1.0 版本](./README_1.0.md)</font> 
