...
R = {
    States.Start: {
        States.Start: -1,    States.A:-1},     # S->S:0, S->A:0
    States.A: {
        States.Start:-1,     States.B:-1},     # A->S:0, A->B:0
    States.B: {
        States.A:-1,         States.C:-1},     # B->A:0, B->C:0
    States.C: {
        States.B:-1,         States.D:-1},     # C->B:0, C->D:0
    States.D: {
        States.C:-1,         States.Home:0},  # D->C:0, D->H:1
    States.Home: {
        States.Home:0},                      # H->H:0
}
