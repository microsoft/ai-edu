...
if __name__=="__main__":
    ...
    mean_errors = MultipleProcess(repeat, algoTD.Saras, ds.Data_Frozen_Lake(), None, episodes, alpha, gamma, ground_truth, checkpoint)
    plt.plot(mean_errors, label="TD_Saras - " + str(alpha))
