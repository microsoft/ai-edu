...
# MC 探索性出发
def MC_ES_test(env, episodes, gamma, policy, exploration):
...
if __name__=="__main__":
    ...
    for exploration in explorations:
        ...
        Q = MC_ES_test(env, max_iteration, gamma, policy, exploration)
        ...
        Qs = []
        for i in range(10):
            q = MC_ES_test(env, max_iteration, gamma, policy, max_iteration)
            Qs.append(q)
