...
![命令提示符内没有正确配置Python](./img/image2.png)
...
![打开NuGet管理界面](./img/image14.png)

如下图所示，在弹出的 NuGet 页面里，点击 **浏览**，然后输入 **ml.scoring**，来手工搜索需要的 NuGet 包。

![搜索“Microsoft.ML.Scoring”包](./img/image15.png)
...
![安装“Microsoft.ML.Scoring”包](./img/image16.png)

##	运行时提示“系统找不到指定的路径” 

![“系统找不到指定的路径”异常](./img/image17.png)
